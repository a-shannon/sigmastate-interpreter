 ...
 \hline
          185 & \hyperref[sec:serialization:operation:VerifyStark]{\lst{VerifyStark}} & \parbox{4cm}{\lst{verifyStark:} \\ \lst{(Coll[Coll[Byte]], Coll[Byte], Coll[Byte], Coll[Byte])} \\ \lst{  => Boolean}} & Verify a profile-defined canonical STARK proof under an immutable network profile. \\
 \hline
 ...
 of discrete logarithm signature protocol.
         \\
 \hline
          206 & \hyperref[sec:serialization:operation:CreateProveDHTuple]{\lst{CreateProveDHTuple}} & \parbox{4cm}{\lst{proveDHTuple:} \\ \lst{(GroupElement, GroupElement, GroupElement, GroupElement)} \\ \lst{  => SigmaProp}} & ... \\
 \hline
