...
class LanguageSpecificationV5 extends LanguageSpecificationBase { suite =>
  ...
  property("BinXor(logical XOR) equivalence") {
    ...
    def success(b: Boolean) = Expected(Success(b), 1768, newDetails, newCost, Seq.fill(V7CostVectorSize)(2012))
  ...
  property("verify should respect Context.initCost") {
    ...
    val newCost = 1768
    val cases = Seq(
      (true, true) -> Expected(Success(false), expectedCost, newDetails, newCost, Seq.fill(V7CostVectorSize)(2012))
    )
    ...
    initialCostInTests.withValue(initCost) {
      val cases = Seq(
        (true, true) -> Expected(Success(false), expectedCost + initCost, newDetails, newCost + initCost, Seq.fill(V7CostVectorSize)(2012 + initCost))
      )
      verifyCases(cases, feature)
    }
  }
  ...
  property("BinXor(logical XOR) test") {
    ...
    def success(b: Boolean) = Expected(Success(b), 1769, newDetails, 1769, Seq.fill(V7CostVectorSize)(2027))
  ...
  property("&& boolean equivalence") {
    ...
    val cases = Seq(
      (false, true) -> Expected(Success(false), 1766, newDetails1, 1766, Seq.fill(V7CostVectorSize)(2010)),
      (false, false) -> Expected(Success(false), 1766, newDetails1, 1766, Seq.fill(V7CostVectorSize)(2010)),
      (true, true) -> Expected(Success(true), 1768, newDetails2, 1768, Seq.fill(V7CostVectorSize)(2012)),
      (true, false) -> Expected(Success(false), 1768, newDetails2, 1768, Seq.fill(V7CostVectorSize)(2012))
    )
  ...
  property("|| boolean equivalence") {
    ...
    val cases = Seq(
      (true, false) -> Expected(Success(true), 1766, newDetails1, 1766, Seq.fill(V7CostVectorSize)(2010)),
      (true, true) -> Expected(Success(true), 1766, newDetails1, 1766, Seq.fill(V7CostVectorSize)(2010)),
      (false, false) -> Expected(Success(false), 1768, newDetails2, 1768, Seq.fill(V7CostVectorSize)(2012)),
      (false, true) -> Expected(Success(true), 1768, newDetails2, 1768, Seq.fill(V7CostVectorSize)(2012))
    )
    verifyCases(cases, eq)
  }
  ...
  def runLazy_And_Or_BooleanEquivalence(implicit evalSettings: EvalSettings) = {
    ...
    verifyCases(
      Seq(
        (true, Expected(Success(true), 1765, newDetails1, 1765, Seq.fill(V7CostVectorSize)(2027))),
    ...
    verifyCases(
      Seq(
        ...
        (false, Expected(Success(false), 1765, newDetails2, 1765, Seq.fill(V7CostVectorSize)(2027)))
      ),
      existingFeature((x: Boolean) => x && (1 / 0 == 1),
        "{ (x: Boolean) => x && (1 / 0 == 1) }",
        FuncValue(
    ...
    verifyCases(
      Seq(
        (false, Expected(Success(false), 1765, newDetails2, 1765, Seq.fill(V7CostVectorSize)(2033))),
        (true, Expected(Success(true), 1768, newDetails3, 1768, Seq.fill(V7CostVectorSize)(2036)))
      ),
    ...
    verifyCases(
      Seq(
        (false, Expected(Success(false), 1765, newDetails2, 1765, Seq.fill(V7CostVectorSize)(2039))),
        (true, Expected(Success(true), 1770, newDetails4, 1770, Seq.fill(V7CostVectorSize)(2044)))
      ),
    ...
    verifyCases(
      Seq(
        (false, Expected(Success(false), 1765, newDetails2, 1765, Seq.fill(V7CostVectorSize)(2045))),
        (true, Expected(Success(true), 1773, newDetails5, 1773, Seq.fill(V7CostVectorSize)(2053)))
      ),
    ...
    verifyCases(
      Seq(
        (false, Expected(new ArithmeticException("/ by zero"))),
        (true, Expected(Success(true), 1773, newDetails6, 1773, Seq.fill(V7CostVectorSize)(2075)))
      ),
    ...
    verifyCases(
      Seq(
        (true, Expected(Success(true), 1768, newDetails7, 1768, Seq.fill(V7CostVectorSize)(2036))),
        (false, Expected(new ArithmeticException("/ by zero")))
      ),
    ...
    verifyCases(
      Seq(
        (true, Expected(Success(true), 1770, newDetails8, 1770, Seq.fill(V7CostVectorSize)(2068))),
        (false, Expected(new ArithmeticException("/ by zero")))
      ),
      existingFeature((x: Boolean) => (x || (1 / 0 == 1)) && (x || (1 / 0 == 1)),
        "{ (x: Boolean) => (x || (1 / 0 == 1)) && (x || (1 / 0 == 1)) }",
    ...
    verifyCases(
      Seq(
        (true, Expected(Success(true), 1775, newDetails9, 1775, Seq.fill(V7CostVectorSize)(2107))),
        (false, Expected(new ArithmeticException("/ by zero")))
      ),
      existingFeature(
    ...
    verifyCases(
      Seq(
        (false, Expected(new ArithmeticException("/ by zero"))),
        (true, Expected(Success(true), 1780, newDetails10, 1780, Seq.fill(V7CostVectorSize)(2156)))
      ),
      existingFeature(
  ...
  property("Byte methods equivalence") {
    ...
    verifyCases(
      {
        def expect(v: Byte) = Expected(Success(v), 1763, TracedCost(traceBase), 1763, Seq.fill(V7CostVectorSize)(1993))
    ...
    verifyCases(
      {
        def expected(v: Short) = Expected(Success(v), 1764, upcastCostDetails(SShort), 1764, Seq.fill(V7CostVectorSize)(1998))
    ...
    verifyCases(
      {
        def expected(v: Int) = Expected(Success(v), 1764, upcastCostDetails(SInt), 1764, Seq.fill(V7CostVectorSize)(1998))
    ...
    verifyCases(
      {
        def expected(v: Long) = Expected(Success(v), 1764, upcastCostDetails(SLong), 1764, Seq.fill(V7CostVectorSize)(1998))
    ...
    verifyCases(
      {
        def expected(v: BigInt) = Expected(Success(v), 1767, upcastCostDetails(SBigInt), 1767, Seq.fill(V7CostVectorSize)(2001))
    ...
    verifyCases(
      {
        def success[T](v: (T, (T, (T, (T, T))))) = Expected(Success(v), 1788, arithOpsCostDetails(SByte), 1788, Seq.fill(V7CostVectorSize)(2116))
  ...
  property("Byte LT, GT, NEQ") {
    ...
    def expect(v: Boolean) = Expected(Success(v), 1768, binaryRelationCostDetails(LT, SByte), 1768, Seq.fill(V7CostVectorSize)(2012))
    ...
    verifyOp(
      swapArgs(LT_cases, cost = 1768, newCostDetails = binaryRelationCostDetails(GT, SByte), expectedV3Costs = Seq.fill(V7CostVectorSize)(2012)),
      ">", GT.apply)(_ > _)

    val neqCases = newCasesFrom3(LT_cases.map(_._1))(_ != _, cost = 1766, newCostDetails = costNEQ(constNeqCost), expectedV3Costs = Seq.fill(V7CostVectorSize)(2010))
  ...
  property("Byte LE, GE") {
    ...
    def expect(v: Boolean) = Expected(Success(v), 1768, binaryRelationCostDetails(LE, SByte), 1768, Seq.fill(V7CostVectorSize)(2012))
    ...
    verifyOp(
      swapArgs(LE_cases, cost = 1768, newCostDetails = binaryRelationCostDetails(GE, SByte), expectedV3Costs = Seq.fill(V7CostVectorSize)(2012)),
      ">=", GE.apply)(_ >= _)
  }
  ...
  property("Short methods equivalence") {
    ...
    verifyCases(
      {
        def success[T](v: T) = Expected(Success(v), 1764, downcastCostDetails(SByte), 1764, Seq.fill(V7CostVectorSize)(1998))
    ...
    verifyCases(
      {
        def success[T](v: T) = Expected(Success(v), 1763, TracedCost(traceBase), 1763, Seq.fill(V7CostVectorSize)(1993))
    ...
    verifyCases(
      {
        def success[T](v: T) = Expected(Success(v), 1764, upcastCostDetails(SInt), 1764, Seq.fill(V7CostVectorSize)(1998))
    ...
    verifyCases(
      {
        def success[T](v: T) = Expected(Success(v), 1764, upcastCostDetails(SLong), 1764, Seq.fill(V7CostVectorSize)(1998))
    ...
    verifyCases(
      {
        def success(v: BigInt) = Expected(Success(v), 1767, upcastCostDetails(SBigInt), 1767, Seq.fill(V7CostVectorSize)(2001))
    ...
    verifyCases(
      {
        def success[T](v: T) = Expected(Success(v), 1788, arithOpsCostDetails(SShort), 1788, Seq.fill(V7CostVectorSize)(2116))
  ...
  property("Short LT, GT, NEQ") {
    ...
    def expect(v: Boolean) = Expected(Success(v), 1768, binaryRelationCostDetails(LT, SShort), 1768, Seq.fill(V7CostVectorSize)(2012))
    ...
    verifyOp(swapArgs(LT_cases, cost = 1768, newCostDetails = binaryRelationCostDetails(GT, SShort), expectedV3Costs = Seq.fill(V7CostVectorSize)(2012)), ">", GT.apply)(_ > _)
  ...
  property("Short LE, GE") {
    ...
    def expect(v: Boolean) = Expected(Success(v), 1768, binaryRelationCostDetails(LE, SShort), 1768, Seq.fill(V7CostVectorSize)(2012))
    ...
    verifyOp(
      swapArgs(LE_cases, cost = 1768, newCostDetails = binaryRelationCostDetails(GE, SShort), expectedV3Costs = Seq.fill(V7CostVectorSize)(2012)),
      ">=", GE.apply)(_ >= _)
  }
  ...
  property("Int methods equivalence") {
    ...
    verifyCases(
      {
        def success[T](v: T) = Expected(Success(v), 1764, downcastCostDetails(SShort), 1764, Seq.fill(V7CostVectorSize)(1998))
    ...
    verifyCases(
      {
        def success[T](v: T) = Expected(Success(v), 1788, arithOpsCostDetails(SInt), 1788, Seq.fill(V7CostVectorSize)(2116))
  ...
  property("Int LT, GT, NEQ") {
    ...
    def expect(v: Boolean) = Expected(Success(v), 1768, binaryRelationCostDetails(LT, SInt), 1768, Seq.fill(V7CostVectorSize)(2012))
    ...
    verifyOp(
      swapArgs(LT_cases, cost = 1768, newCostDetails = binaryRelationCostDetails(GT, SInt), expectedV3Costs = Seq.fill(V7CostVectorSize)(2012)),
      ">", GT.apply)(_ > _)
  ...
  property("Int LE, GE") {
    val o = ExactOrdering.IntIsExactOrdering
    def expect(v: Boolean) = Expected(Success(v), 1768, binaryRelationCostDetails(LE, SInt), 1768, Seq.fill(V7CostVectorSize)(2012))
    ...
    verifyOp(
      swapArgs(LE_cases, cost = 1768, newCostDetails = binaryRelationCostDetails(GE, SInt), expectedV3Costs = Seq.fill(V7CostVectorSize)(2012)),
      ">=", GE.apply)(_ >= _)
  }
  ...
  property("Long.toInt method") {
    verifyCases(
      {
        def success[T](v: T) = Expected(Success(v), 1764, downcastCostDetails(SInt), 1764, Seq.fill(V7CostVectorSize)(1998))
  ...
  property("Long methods equivalence") {
    ...
    verifyCases(
      {
        def success[T](v: T) = Expected(Success(v), 1788, arithOpsCostDetails(SLong), 1788, Seq.fill(V7CostVectorSize)(2116))
        Seq(
  ...
  property("Long LT, GT, NEQ") {
    ...
    def expect(v: Boolean) = Expected(Success(v), 1768, binaryRelationCostDetails(LT, SLong), 1768, Seq.fill(V7CostVectorSize)(2012))
    ...
    verifyOp(
      swapArgs(LT_cases, cost = 1768, newCostDetails = binaryRelationCostDetails(GT, SLong), expectedV3Costs = Seq.fill(V7CostVectorSize)(2012)),
      ">", GT.apply)(_ > _)

    val neqCases = newCasesFrom3(LT_cases.map(_._1))(_ != _, cost = 1766, newCostDetails = costNEQ(constNeqCost), Seq.fill(V7CostVectorSize)(2010))
    verifyOp(neqCases, "!=", NEQ.apply)(_ != _)
  }

  property("Long LE, GE") {
    val o = ExactOrdering.LongIsExactOrdering
    def expect(v: Boolean) = Expected(Success(v), 1768, binaryRelationCostDetails(LE, SLong), 1768, Seq.fill(V7CostVectorSize)(2012))
    ...
    verifyOp(
      swapArgs(LE_cases, cost = 1768, newCostDetails = binaryRelationCostDetails(GE, SLong), expectedV3Costs = Seq.fill(V7CostVectorSize)(2012)),
      ">=", GE.apply)(_ >= _)
  }
  ...
  property("BigInt methods equivalence") {
    verifyCases(
      {
        def success(v: BigInt) = Expected(Success(v), 1764, TracedCost(traceBase), 1764, Seq.fill(V7CostVectorSize)(1994))
        Seq(
    ...
    verifyCases(
      {
        def success(v: (BigInt, (BigInt, (BigInt, (BigInt, BigInt))))) =
          Expected(Success(v), 1793, arithOpsCostDetails(SBigInt), 1793, Seq.fill(V7CostVectorSize)(2121))
        Seq(
  ...
  property("BigInt LT, GT, NEQ") {
    ...
    def expect(v: Boolean) = Expected(Success(v), 1768, binaryRelationCostDetails(LT, SBigInt), 1768, Seq.fill(V7CostVectorSize)(2012))
    ...
    verifyOp(
      swapArgs(LT_cases, cost = 1768, newCostDetails = binaryRelationCostDetails(GT, SBigInt), expectedV3Costs = Seq.fill(V7CostVectorSize)(2012)),
      ">", GT.apply)(o.gt(_, _))

    val constBigIntCost = Array[CostItem](FixedCostItem(NamedDesc("EQ_BigInt"), FixedCost(JitCost(5))))
    val neqCases = newCasesFrom3(LT_cases.map(_._1))(_ != _, cost = 1766, newCostDetails = costNEQ(constBigIntCost), expectedV3Costs = Seq.fill(V7CostVectorSize)(2010))
    verifyOp(neqCases, "!=", NEQ.apply)(_ != _)
  }
  ...
  property("BigInt LE, GE") {
    ...
    def expect(v: Boolean) = Expected(Success(v), 1768, binaryRelationCostDetails(LE, SBigInt), 1768, Seq.fill(V7CostVectorSize)(2012))
    ...
    verifyOp(
      swapArgs(LE_cases, cost = 1768, newCostDetails = binaryRelationCostDetails(GE, SBigInt), expectedV3Costs = Seq.fill(V7CostVectorSize)(2012)),
      ">=", GE.apply)(o.gteq(_, _))
  }
  ...
  property("NEQ of pre-defined types") {
    verifyNeq(ge1, ge2, 1783, Array[CostItem](FixedCostItem(NamedDesc("EQ_GroupElement"), FixedCost(JitCost(172)))), 1783, Seq.fill(V7CostVectorSize)(2027))(_.asInstanceOf[CGroupElement].copy())
    verifyNeq(t1, t2, 1767, Array[CostItem](FixedCostItem(NamedDesc("EQ_AvlTree"), FixedCost(JitCost(6)))), 1767, Seq.fill(V7CostVectorSize)(2019))(_.asInstanceOf[CAvlTree].copy())
    verifyNeq(b1, b2, 1767, Array[CostItem](), 1767, Seq.fill(V7CostVectorSize)(2019))(_.asInstanceOf[CBox].copy())
    verifyNeq(preH1, preH2, 1766, Array[CostItem](FixedCostItem(NamedDesc("EQ_PreHeader"), FixedCost(JitCost(4)))), 1766, Seq.fill(V7CostVectorSize)(2018))(_.asInstanceOf[CPreHeader].copy())
    verifyNeq(h1, h2, 1767, Array[CostItem](FixedCostItem(NamedDesc("EQ_Header"), FixedCost(JitCost(6)))), 1767, Seq.fill(V7CostVectorSize)(2019))(_.asInstanceOf[CHeader].copy())
  }
  ...
  property("NEQ of tuples of numerics") {
    ...
    verifyNeq((0.toByte, 1.toByte), (1.toByte, 1.toByte), 1767, tuplesNeqCost, 1767, Seq.fill(V7CostVectorSize)(2019))(_.copy())
    verifyNeq((0.toShort, 1.toByte), (1.toShort, 1.toByte), 1767, tuplesNeqCost, 1767, Seq.fill(V7CostVectorSize)(2029))(_.copy())
    verifyNeq((0, 1.toByte), (1, 1.toByte), 1767, tuplesNeqCost, 1767, Seq.fill(V7CostVectorSize)(2029))(_.copy())
    verifyNeq((0.toLong, 1.toByte), (1.toLong, 1.toByte), 1767, tuplesNeqCost, 1767, Seq.fill(V7CostVectorSize)(2029))(_.copy())
    verifyNeq((0.toBigInt, 1.toByte), (1.toBigInt, 1.toByte), 1767, Array(
      FixedCostItem(NamedDesc("EQ_Tuple"), FixedCost(JitCost(4))),
      FixedCostItem(NamedDesc("EQ_BigInt"), FixedCost(JitCost(5)))
    ), 1767, Seq.fill(V7CostVectorSize)(2029))(_.copy())
  }
  ...
  property("NEQ of tuples of pre-defined types") {
    ...
    verifyNeq((ge1, ge1), (ge1, ge2), 1801, groupNeqCost, 1801, Seq.fill(V7CostVectorSize)(2053))(_.copy())
    ...
    verifyNeq((t1, t1), (t1, t2), 1768, treeNeqCost, 1768, Seq.fill(V7CostVectorSize)(2038))(_.copy())
    verifyNeq((b1, b1), (b1, b2), 1768, Array[CostItem](), 1768, Seq.fill(V7CostVectorSize)(2038))(_.copy())
    ...
    verifyNeq((preH1, preH1), (preH1, preH2), 1767, preHeaderNeqCost, 1767, Seq.fill(V7CostVectorSize)(2037))(_.copy())
    ...
    verifyNeq((h1, h1), (h1, h2), 1768, headerNeqCost, 1768, Seq.fill(V7CostVectorSize)(2038))(_.copy())
  }
  ...
  property("NEQ of nested tuples") {
    ...
    verifyNeq((ge1, (t1, t1)), (ge1, (t1, t2)), 1785, nestedTuplesNeqCost1, 1785, Seq.fill(V7CostVectorSize)(2063))(_.copy())
    verifyNeq((ge1, (t1, (b1, b1))), (ge1, (t1, (b1, b2))), 1786, nestedTuplesNeqCost2, 1786, Seq.fill(V7CostVectorSize)(2080))(_.copy())
    verifyNeq((ge1, (t1, (b1, (preH1, preH1)))), (ge1, (t1, (b1, (preH1, preH2)))), 1787, nestedTuplesNeqCost3, 1787, Seq.fill(V7CostVectorSize)(2097))(_.copy())
    verifyNeq((ge1, (t1, (b1, (preH1, (h1, h1))))), (ge1, (t1, (b1, (preH1, (h1, h2))))), 1788, nestedTuplesNeqCost4, 1788, Seq.fill(V7CostVectorSize)(2114))(_.copy())

    verifyNeq(((ge1, t1), t1), ((ge1, t1), t2), 1785, nestedTuplesNeqCost5, 1785, Seq.fill(V7CostVectorSize)(2063))(_.copy())
    verifyNeq((((ge1, t1), b1), b1), (((ge1, t1), b1), b2), 1786, nestedTuplesNeqCost6, 1786, Seq.fill(V7CostVectorSize)(2080))(_.copy())
    verifyNeq((((ge1, t1), b1), (preH1, preH1)), (((ge1, t1), b1), (preH1, preH2)), 1787, nestedTuplesNeqCost7, 1787, Seq.fill(V7CostVectorSize)(2097))(_.copy())
    verifyNeq((((ge1, t1), b1), (preH1, (h1, h1))), (((ge1, t1), b1), (preH1, (h1, h2))), 1788, nestedTuplesNeqCost8, 1788, Seq.fill(V7CostVectorSize)(2114))(_.copy())
  }
  ...
  property("NEQ of collections of pre-defined types") {
    ...
    verifyNeq(Coll[Byte](), Coll(1.toByte), 1766, collNeqCost1, 1766, Seq.fill(V7CostVectorSize)(2018))(cloneColl(_))
    verifyNeq(Coll[Byte](0, 1), Coll(1.toByte, 1.toByte), 1768,
      ...
      1768,
       Seq.fill(V7CostVectorSize)(2020)
    )(cloneColl(_))

    verifyNeq(Coll[Short](), Coll(1.toShort), 1766, collNeqCost1, 1766, Seq.fill(V7CostVectorSize)(2018))(cloneColl(_))
    ...
    verifyNeq(Coll[Int](), Coll(1), 1766, collNeqCost1, 1766, Seq.fill(V7CostVectorSize)(2018))(cloneColl(_))
    ...
    verifyNeq(Coll[Long](), Coll(1.toLong), 1766, collNeqCost1, 1766, Seq.fill(V7CostVectorSize)(2018))(cloneColl(_))
    ...
    verifyNeq(Coll[BigInt](), Coll(1.toBigInt), 1766, collNeqCost1, 1766, Seq.fill(V7CostVectorSize)(2018))(cloneColl(_))
    ...
    verifyNeq(Coll[GroupElement](), Coll(ge1), 1766, collNeqCost1, 1766, Seq.fill(V7CostVectorSize)(2018))(cloneColl(_))
    ...
    verifyNeq(Coll[AvlTree](), Coll(t1), 1766, collNeqCost1, 1766, Seq.fill(V7CostVectorSize)(2028))(cloneColl(_))
    ...
    verifyNeq(Coll[AvlTree](t1), Coll(t2), 1768,
      ...
      1768,
      Seq.fill(V7CostVectorSize)(2030)
    )(cloneColl(_))
    ...
    { // since SBox.isConstantSize = false, the cost is different among cases
      ...
      verifyOp(Seq(
        (x, x) -> Expected(Success(false), 1768, costNEQ(collNeqCost2), 1768, Seq.fill(V7CostVectorSize)(2030)),
        (x, copied_x) -> Expected(Success(false), 1768, costNEQ(collNeqCost2), 1768, Seq.fill(V7CostVectorSize)(2030)),
        (copied_x, x) -> Expected(Success(false), 1768, costNEQ(collNeqCost2), 1768, Seq.fill(V7CostVectorSize)(2030)),
        (x, y) -> Expected(Success(true), 1766, costNEQ(collNeqCost1), 1766, Seq.fill(V7CostVectorSize)(2028)),
        (y, x) -> Expected(Success(true), 1766, costNEQ(collNeqCost1), 1766, Seq.fill(V7CostVectorSize)(2028))
      ),
    ...
    verifyNeq(Coll[PreHeader](), Coll(preH1), 1766, collNeqCost1, 1766, Seq.fill(V7CostVectorSize)(2028))(cloneColl(_))
    ...
    verifyNeq(Coll[Header](), Coll(h1), 1766, collNeqCost1, 1766, Seq.fill(V7CostVectorSize)(2028))(cloneColl(_))
    verifyNeq(Coll[Header](h1), Coll(h2), 1768,
      Array(
        FixedCostItem(NamedDesc("MatchType"), FixedCost(JitCost(1))),
        ast.SeqCostItem(NamedDesc("EQ_COA_Header"), PerItemCost(JitCost(15), JitCost(5), 1), 1)),
      1768, Seq.fill(V7CostVectorSize)(2030)
    )(cloneColl(_))
  }
  ...
  property("NEQ of nested collections and tuples") {
    ...
    verifyNeq(Coll[Coll[Int]](), Coll(Coll[Int]()), 1766, nestedNeq1, 1766, Seq.fill(V7CostVectorSize)(2018))(cloneColl(_))
    verifyNeq(Coll(Coll[Int]()), Coll(Coll[Int](1)), 1767, nestedNeq2, 1767, Seq.fill(V7CostVectorSize)(2019))(cloneColl(_))
    verifyNeq(Coll(Coll[Int](1)), Coll(Coll[Int](2)), 1769, nestedNeq3, 1769, Seq.fill(V7CostVectorSize)(2021))(cloneColl(_))
    verifyNeq(Coll(Coll[Int](1)), Coll(Coll[Int](1, 2)), 1767, nestedNeq2, 1767, Seq.fill(V7CostVectorSize)(2019))(cloneColl(_))
    ...
    verifyNeq(Coll(Coll((1, 10.toBigInt))), Coll(Coll((1, 11.toBigInt))), 1770, nestedNeq4, 1770, Seq.fill(V7CostVectorSize)(2048))(cloneColl(_))
    verifyNeq(Coll(Coll(Coll((1, 10.toBigInt)))), Coll(Coll(Coll((1, 11.toBigInt)))), 1771, nestedNeq5, 1771, Seq.fill(V7CostVectorSize)(2057))(cloneColl(_))
    verifyNeq(
      (Coll(
         (Coll(
      ...
      nestedNeq6,
      1774,
      Seq.fill(V7CostVectorSize)(2100)
  ...
  property("GroupElement.getEncoded equivalence") {
    verifyCases(
    {
      def success[T](v: T) = Expected(Success(v), 1790, methodCostDetails(SGroupElementMethods.GetEncodedMethod, 250), 1790, Seq.fill(V7CostVectorSize)(2026))
      Seq(
  ...
  property("decodePoint(GroupElement.getEncoded) equivalence") {
    verifyCases(
    {
      ...
      def success[T](v: T) = Expected(Success(v), 1837, costDetails, 1837, Seq.fill(V7CostVectorSize)(2081))
      Seq(
        (ge1, success(true)),
        (ge2, success(true)),
        (ge3, success(true)),
  ...
  property("GroupElement.negate equivalence") {
    verifyCases(
    {
      def success[T](v: T) = Expected(Success(v), 1785, methodCostDetails(SGroupElementMethods.NegateMethod, 45), 1785, Seq.fill(V7CostVectorSize)(2021))
      Seq(
  ...
  property("GroupElement.exp equivalence") {
    ...
    if (lowerMethodCallsInTests) {
      ...
      verifyCases(cases(1873, costDetails, Seq.fill(V7CostVectorSize)(2121)),
        existingFeature(
          scalaFunc,
          script,
          FuncValue(
    ...
    verifyCases(
      {
        ...
        def success[T](v: T) = Expected(Success(v), 1787, costDetails, 1787, Seq.fill(V7CostVectorSize)(2031))
        Seq(
  ...
  property("AvlTree properties equivalence") {
    ...
    verifyCases(
      {
        def success[T](v: T) = Expected(Success(v), 1767, methodCostDetails(SAvlTreeMethods.digestMethod, 15), 1767, Seq.fill(V7CostVectorSize)(2003))
        Seq(
    ...
    verifyCases(
      {
        def success[T](v: T) = Expected(Success(v), 1765, methodCostDetails(SAvlTreeMethods.enabledOperationsMethod, 15), 1765, Seq.fill(V7CostVectorSize)(2001))
        Seq(
          (t1, success(6.toByte)),
          (t2, success(0.toByte)),
          (t3, success(1.toByte))
    ...
    verifyCases(
      {
        def success[T](v: T) = Expected(Success(v), 1765, methodCostDetails(SAvlTreeMethods.keyLengthMethod, 15), 1765, Seq.fill(V7CostVectorSize)(2001))
        Seq(
          (t1, success(1)),
          (t2, success(32)),
          (t3, success(128))
    ...
    verifyCases(
      {
        ...
        Seq(
          (t1, success(Some(1), 1766, Seq.fill(V7CostVectorSize)(2002))),
          (t2, success(Some(64), 1766, Seq.fill(V7CostVectorSize)(2002))),
          (t3, success(None, 1765, Seq.fill(V7CostVectorSize)(2001)))
        )
      },
    ...
    verifyCases(
      {
        def success[T](v: T) = Expected(Success(v), 1765, methodCostDetails(SAvlTreeMethods.isInsertAllowedMethod, 15), 1765, Seq.fill(V7CostVectorSize)(2001))
        Seq(
          (t1, success(false)),
          (t2, success(false)),
          (t3, success(true))
    ...
    verifyCases(
      {
        def success[T](v: T) = Expected(Success(v), 1765, methodCostDetails(SAvlTreeMethods.isUpdateAllowedMethod, 15), 1765, Seq.fill(V7CostVectorSize)(2001))
        Seq(
          (t1, success(true)),
          (t2, success(false)),
          (t3, success(false))
    ...
    verifyCases(
      {
        def success[T](v: T) = Expected(Success(v), 1765, methodCostDetails(SAvlTreeMethods.isRemoveAllowedMethod, 15), 1765, Seq.fill(V7CostVectorSize)(2001))
        Seq(
          (t1, success(true)),
          (t2, success(false)),
          (t3, success(false))
  ...
  property("AvlTree.{contains, get, getMany, updateDigest, updateOperations} equivalence") {
...

    {
      ...
      getMany.checkExpected(input, Expected(Success(expRes), 1845, costDetails, 1845, Seq.fill(V7CostVectorSize)(2139)))
    }
    ...
    forAll(table) { (key, okContains, valueOpt, additionalCost, additionalDetails) =>
      ...
      // positive test
      {
        ...
        val expectedV3Costs: Seq[Int] = Seq.fill(V7CostVectorSize)(2082)
      ...
      {
        val input = (tree, (keys, proof))
        val expectedV3Costs: Seq[Int] = Seq.fill(V7CostVectorSize)(2085 + additionalCost)
...

      {
        ...
        updateDigest.checkExpected(input, Expected(Success(res), 1771, updateDigestCostDetails, 1771, Seq.fill(V7CostVectorSize)(2029)))
      }
...

      {
        ...
        updateOperations.checkExpected(input, Expected(Success(res), 1771, updateOperationsCostDetails, 1771, Seq.fill(V7CostVectorSize)(2025)))
      }
...

      {
        ...
        res shouldBe false
        contains.checkExpected(input, Expected(Success(res), 1790, costDetails(105 + additionalDetails), 1790, Seq.fill(V7CostVectorSize)(2082)))
      }
  ...
  property("AvlTree.update equivalence") {
    ...
    { // positive: update to newValue
      ...
      update.checkExpected(input, Expected(Success(res), 1805, costDetails2, 1805, Seq.fill(V7CostVectorSize)(2111)))
    }
    ...
    { // negative: readonly tree
      ...
      update.checkExpected(input, Expected(Success(None), 1772, costDetails1, 1772, Seq.fill(V7CostVectorSize)(2078)))
    }
    ...
    { // negative: invalid key
      ...
      update.checkExpected(input, Expected(Success(None), 1801, costDetails3, 1801, Seq.fill(V7CostVectorSize)(2107)))
    }
  ...
  property("AvlTree.remove equivalence") {
...

    {
      ...
      val res = Some(endTree)
      remove.checkExpected(input, Expected(Success(res), 1832, costDetails1, 1832, Seq.fill(V7CostVectorSize)(2126)))
    }

    {
      ...
      { // positive
        ...
        val res = Some(endTree)
        remove.checkExpected(input, Expected(Success(res), 1806, costDetails2, 1806, Seq.fill(V7CostVectorSize)(2100)))
      }

      { // negative: readonly tree
        val readonlyTree = createTree(preRemoveDigest)
        val input = (readonlyTree, (keys, removeProof))
        remove.checkExpected(input, Expected(Success(None), 1772, costDetails3, 1772, Seq.fill(V7CostVectorSize)(2066)))
      }
      ...
      { // negative: invalid key
        ...
        remove.checkExpected(input, Expected(Success(None), 1802, costDetails4, 1802, Seq.fill(V7CostVectorSize)(2096)))
      }
  ...
  property("longToByteArray equivalence") {
    ...
    verifyCases(
      {
        def success[T](v: T) = Expected(Success(v), 1767, costDetails, 1767, Seq.fill(V7CostVectorSize)(1999))
        Seq(
    ...
    verifyCases(
      {
        ...
        Seq(
          ...
          (Helpers.decodeBytes("80d6c201"),
            Expected(Success(CBigInt(new BigInteger("-7f293dff", 16))), 1767, costDetails, 1767, Seq.fill(V7CostVectorSize)(1999))),
          (Helpers.decodeBytes("70d6c20170d6c201"),
            Expected(Success(CBigInt(new BigInteger("70d6c20170d6c201", 16))), 1767, costDetails, 1767, Seq.fill(V7CostVectorSize)(1999))),
          (Helpers.decodeBytes(
  ...
  property("byteArrayToLong equivalence") {
    ...
    verifyCases(
      {
        def success[T](v: T) = Expected(Success(v), 1765, costDetails, 1765, Seq.fill(V7CostVectorSize)(1997))
        Seq(
    ...
    verifyCases(
      {
        ...
        def success[T](v: T) = Expected(Success(v), 1766, costDetails, 1766, Seq.fill(V7CostVectorSize)(1998))
        Seq(
    ...
    verifyCases(
      {
        ...
        def success[T](v: T) = Expected(Success(v), 1764, costDetails, 1764, Seq.fill(V7CostVectorSize)(1996))
        Seq(
    ...
    verifyCases(
      {
        ...
        def success[T](v: T) = Expected(Success(v), 1767, costDetails, 1767, Seq.fill(V7CostVectorSize)(2001))
        Seq(
          (b1, success((
              677407,
    ...
    verifyCases(
      Seq(
        b1 -> Expected(Success(Coll[(Coll[Byte], Long)](
          ...
          ).map(identity)), 1772, methodCostDetails(SBoxMethods.tokensMethod, 15), 1772, Seq.fill(V7CostVectorSize)(2012)),
        b2 -> Expected(Success(Coll[(Coll[Byte], Long)]().map(identity)), 1766, methodCostDetails(SBoxMethods.tokensMethod, 15), 1766, Seq.fill(V7CostVectorSize)(2006))
      ),
  ...
  property("Conditional access to registers") {
    ...
    verifyCases(
      Seq(
        (box1, Expected(Success(1024.toShort), 1774, expCostDetails1, 1774, Seq.fill(V7CostVectorSize)(2042))),
        (box2, Expected(
          new InvalidType("Cannot getReg[Short](5): invalid type of value TestValue(1048576) at id=5")
        )),
        (box3, Expected(Success(0.toShort), 1772, expCostDetails2, 1772, Seq.fill(V7CostVectorSize)(2040)))
      ),
      existingFeature(
        { (x: Box) =>
    ...
    verifyCases(
      Seq(
        (box1, Expected(Success(1024), cost = 1785, expCostDetails3, 1785, Seq.fill(V7CostVectorSize)(2129))),
        (box2, Expected(Success(1024 * 1024), cost = 1786, expCostDetails4, 1786, Seq.fill(V7CostVectorSize)(2130))),
        (box3, Expected(Success(0), cost = 1779, expCostDetails5, 1779, Seq.fill(V7CostVectorSize)(2123))),
        (box4, Expected(Success(-1), cost = 1772, expCostDetails2, 1772, Seq.fill(V7CostVectorSize)(2116)))
      ),
      existingFeature(
        { (x: Box) =>
  ...
  property("Advanced Box test") {
    ...
    verifyCases(
      Seq(
        (box1, Expected(Success(1.toByte), cost = 1770, expCostDetails, 1770, Seq.fill(V7CostVectorSize)(2008))),
    ...
    verifyCases(
      Seq(
        (box1, Expected(Success(1024.toShort), cost = 1770, expCostDetails, 1770, Seq.fill(V7CostVectorSize)(2008))),
    ...
    verifyCases(
      Seq(
        (box1, Expected(Success(1024 * 1024), cost = 1770, expCostDetails, 1770, Seq.fill(V7CostVectorSize)(2008)))
      ),
    ...
    verifyCases(
      Seq(
        (box1, Expected(Success(1024.toLong), cost = 1770, expCostDetails, 1770, Seq.fill(V7CostVectorSize)(2008)))
      ),
    ...
    verifyCases(
      Seq(
        (box1, Expected(Success(CBigInt(BigInteger.valueOf(222L))), cost = 1770, expCostDetails, 1770, Seq.fill(V7CostVectorSize)(2008)))
      ),
    ...
    verifyCases(
      Seq(
        (box1, Expected(Success(CAvlTree(
          ...
          cost = 1770,
          expCostDetails,
          1770, Seq.fill(V7CostVectorSize)(2008))
        )),
  ...
  property("PreHeader properties equivalence") {
    ...
    verifyCases(
      Seq((preH1, Expected(Success(0.toByte), cost = 1765, methodCostDetails(SPreHeaderMethods.versionMethod, 10), 1765, Seq.fill(V7CostVectorSize)(2001)))),
    ...
    verifyCases(
      Seq((preH1, Expected(Success(
        ...
        cost = 1766, methodCostDetails(SPreHeaderMethods.parentIdMethod, 10), 1766, Seq.fill(V7CostVectorSize)(2002)))),
      existingPropTest("parentId", { (x: PreHeader) => x.parentId }))

    verifyCases(
      Seq((preH1, Expected(Success(6306290372572472443L), cost = 1765, methodCostDetails(SPreHeaderMethods.timestampMethod, 10), 1765, Seq.fill(V7CostVectorSize)(2001)))),
      existingPropTest("timestamp", { (x: PreHeader) => x.timestamp }))

    verifyCases(
      Seq((preH1, Expected(Success(-3683306095029417063L), cost = 1765, methodCostDetails(SPreHeaderMethods.nBitsMethod, 10), 1765, Seq.fill(V7CostVectorSize)(2001)))),
      existingPropTest("nBits", { (x: PreHeader) => x.nBits }))

    verifyCases(
      Seq((preH1, Expected(Success(1), cost = 1765, methodCostDetails(SPreHeaderMethods.heightMethod, 10), 1765, Seq.fill(V7CostVectorSize)(2001)))),
    ...
    verifyCases(
      Seq((preH1, Expected(Success(
        ...
        cost = 1782, methodCostDetails(SPreHeaderMethods.minerPkMethod, 10), 1782, Seq.fill(V7CostVectorSize)(2018)))),
      existingPropTest("minerPk", { (x: PreHeader) => x.minerPk }))

    verifyCases(
      Seq((preH1, Expected(Success(Helpers.decodeBytes("ff8087")), cost = 1766, methodCostDetails(SPreHeaderMethods.votesMethod, 10), 1766, Seq.fill(V7CostVectorSize)(2002)))),
  ...
  property("Header properties equivalence") {
    verifyCases(
      Seq((h1, Expected(Success(
        ...
        cost = 1766, methodCostDetails(SHeaderMethods.idMethod, 10), 1766, Seq.fill(V7CostVectorSize)(2002)))),
      existingPropTest("id", { (x: Header) => x.id }))

    verifyCases(
      Seq((h1, Expected(Success(1.toByte), cost = 1765, methodCostDetails(SHeaderMethods.versionMethod, 10), 1765, Seq.fill(V7CostVectorSize)(2001)))),
    ...
    verifyCases(
      Seq((h1, Expected(Success(
        ...
        cost = 1766, methodCostDetails(SHeaderMethods.parentIdMethod, 10), 1766, Seq.fill(V7CostVectorSize)(2002)))),
    ...
    verifyCases(
      Seq((h1, Expected(Success(
        ...
        cost = 1766, methodCostDetails(SHeaderMethods.ADProofsRootMethod, 10), 1766, Seq.fill(V7CostVectorSize)(2002)))),
      existingPropTest("ADProofsRoot", { (x: Header) => x.ADProofsRoot }))

    verifyCases(
      Seq((h1, Expected(Success(CAvlTree(createAvlTreeData())), cost = 1765, methodCostDetails(SHeaderMethods.stateRootMethod, 10), 1765, Seq.fill(V7CostVectorSize)(2001)))),
    ...
    verifyCases(
      Seq((h1, Expected(Success(
        ...
        cost = 1766, methodCostDetails(SHeaderMethods.transactionsRootMethod, 10), 1766, Seq.fill(V7CostVectorSize)(2002)))),
      existingPropTest("transactionsRoot", { (x: Header) => x.transactionsRoot }))

    verifyCases(
      Seq((h1, Expected(Success(1L), cost = 1765, methodCostDetails(SHeaderMethods.timestampMethod, 10), 1765, Seq.fill(V7CostVectorSize)(2001)))),
      existingPropTest("timestamp", { (x: Header) => x.timestamp }))

    verifyCases(
      Seq((h1, Expected(Success(-1L), cost = 1765, methodCostDetails(SHeaderMethods.nBitsMethod, 10), 1765, Seq.fill(V7CostVectorSize)(2001)))),
      existingPropTest("nBits", { (x: Header) => x.nBits }))

    verifyCases(
      Seq((h1, Expected(Success(1), cost = 1765, methodCostDetails(SHeaderMethods.heightMethod, 10), 1765, Seq.fill(V7CostVectorSize)(2001)))),
    ...
    verifyCases(
      Seq((h1, Expected(Success(
        ...
        cost = 1766, methodCostDetails(SHeaderMethods.extensionRootMethod, 10), 1766, Seq.fill(V7CostVectorSize)(2002)))),
    ...
    verifyCases(
      Seq((h1, Expected(Success(
        ...
        cost = 1782, methodCostDetails(SHeaderMethods.minerPkMethod, 10), 1782, Seq.fill(V7CostVectorSize)(2018)))),
    ...
    verifyCases(
      Seq((h1, Expected(Success(
        ...
        cost = 1782, methodCostDetails(SHeaderMethods.powOnetimePkMethod, 10), 1782, Seq.fill(V7CostVectorSize)(2018)))),
      existingPropTest("powOnetimePk", { (x: Header) => x.powOnetimePk }))

    verifyCases(
      Seq((h1, Expected(Success(
        Helpers.decodeBytes("7f4f09012a807f01")),
        cost = 1766, methodCostDetails(SHeaderMethods.powNonceMethod, 10), 1766, Seq.fill(V7CostVectorSize)(2002)))),
      existingPropTest("powNonce", { (x: Header) => x.powNonce }))

    verifyCases(
      Seq((h1, Expected(Success(
        CBigInt(SecP256K1Group.order.divide(new BigInteger("2")))),
        cost = 1765, methodCostDetails(SHeaderMethods.powDistanceMethod, 10), 1765, Seq.fill(V7CostVectorSize)(2001)))),
      existingPropTest("powDistance", { (x: Header) => x.powDistance }))

    verifyCases(
      Seq((h1, Expected(Success(
        Helpers.decodeBytes("7f0180")),
        cost = 1766, methodCostDetails(SHeaderMethods.votesMethod, 10), 1766, Seq.fill(V7CostVectorSize)(2002)))),
  ...
  property("Context properties equivalence") {
    ...
    verifyCases(
      Seq(
        (ctx, Expected(Success(dataBox), cost = 1769, costDetails, 1769, Seq.fill(V7CostVectorSize)(2017))),
    ...
    verifyCases(
      Seq(
        (ctx, Expected(Success(
          ...
          cost = 1772, idCostDetails, 1772, Seq.fill(V7CostVectorSize)(2022)))
      ),
    ...
    verifyCases(
      Seq(ctx -> Expected(Success(ctx.HEIGHT), cost = 1766, heightCostDetails, 1766, Seq.fill(V7CostVectorSize)(1994))),
      existingFeature(
        { (x: Context) => x.HEIGHT },
        "{ (x: Context) => x.HEIGHT }",
    ...
    verifyCases(
      Seq((ctx, Expected(Success(Coll[Long](80946L)), cost = 1770, inputsCostDetails1, 1770, Seq.fill(V7CostVectorSize)(2014)))),
      existingFeature(
    ...
    verifyCases(
      Seq((ctx, Expected(Success(Coll((80946L, 80946L))), cost = 1774, inputsCostDetails2, 1774, Seq.fill(V7CostVectorSize)(2042)))),
      existingFeature(
    ...
    verifyCases(
      Seq(
        (ctx, Expected(
          ...
          newCost = 1766,
          newVersionedResults = {
            val expectedV3Costs = Seq.fill(V7CostVectorSize)(2002)
            ...
            val costs = if (activatedVersionInTests >= V6SoftForkVersion) {
              ...
              Seq.fill(V7CostVectorSize)(1766)
            }
            val res = (ExpectedResult(Success(0), Some(1766)) -> Some(selfCostDetails))
            (0 until V7CostVectorSize).map(version => version -> (ExpectedResult(Success(0), Some(costs(version))) -> Some(selfCostDetails)))
          }))
      ),
      changedFeature(
    ...
    verifyCases(
      Seq(ctx -> Expected(Success(ctx.LastBlockUtxoRootHash), cost = 1766, methodCostDetails(SContextMethods.lastBlockUtxoRootHashMethod, 15), 1766, Seq.fill(V7CostVectorSize)(2002))),
    ...
    verifyCases(
      Seq(ctx -> Expected(Success(ctx.LastBlockUtxoRootHash.isUpdateAllowed), cost = 1767, isUpdateAllowedCostDetails, 1767, Seq.fill(V7CostVectorSize)(2009))),
      existingFeature(
    ...
    verifyCases(
      Seq(ctx -> Expected(Success(ctx.minerPubKey), cost = 1767, methodCostDetails(SContextMethods.minerPubKeyMethod, 20), 1767, Seq.fill(V7CostVectorSize)(2003))),
    ...
    val getVarCostDetails = TracedCost(
      Array(
        ...
        FixedCostItem(OptionGet)))
    verifyCases(
      Seq((ctx, Expected(Success(true), cost = 1765, getVarCostDetails, 1765, Seq.fill(V7CostVectorSize)(1999)))),
  ...
  property("Conditional access to data box register using isDefined") {
    ...
    verifyCases(
      Seq(
        ctx -> Expected(Success(-135729055492651903L), 1779, registerIsDefinedCostDetails, 1779, Seq.fill(V7CostVectorSize)(2065))
      ),
      existingFeature(
      { (x: Context) =>
    ...
    verifyCases(
      Seq(
        ctx -> Expected(Failure(expectedError), 0, CostDetails.ZeroCost, 1793,
          newVersionedResults = {
            val expectedV3Costs = Seq.fill(V7CostVectorSize)(2121)
            // V3 activation will have different costs due to deserialization cost
            val costs = if (activatedVersionInTests >= V6SoftForkVersion) {
              expectedV3Costs
            } else {
              Seq.fill(V7CostVectorSize)(1793)
            }
            Seq.tabulate(V7CostVectorSize)(v => v -> (ExpectedResult(Success(true), Some(costs(v))) -> None))
          }
        )
      ),
      changedFeature(
  ...
  property("Conditional access OUTPUTS(0).R4 using tag in R5") {
    ...
    verifyCases(
      Seq(
        ctx -> Expected(Success(5008366408131208436L), 1791, registerTagCostDetails1, 1791, Seq.fill(V7CostVectorSize)(2153)),
        ctxWithRegsInOutput(ctx, Map(
          ErgoBox.R5 -> LongConstant(0L),
          ErgoBox.R4 -> ShortConstant(10))) -> Expected(Success(10L), 1790, registerTagCostDetails2, 1790, Seq.fill(V7CostVectorSize)(2152)),
        ctxWithRegsInOutput(ctx, Map(
          ErgoBox.R4 -> ShortConstant(10))) -> Expected(Success(-1L), 1777, registerTagCostDetails3, 1777, Seq.fill(V7CostVectorSize)(2139))
      ),
      existingFeature(
      { (x: Context) =>
  ...
  property("Conditional access OUTPUTS(0).R4 using tag in R5 (plus action)") {
    ...
    verifyCases(
      Seq(
        // case 1L
        ctx -> Expected(Success(5008366408131289382L), 1794, tagRegisterCostDetails1, 1794, Seq.fill(V7CostVectorSize)(2168)),
        // case 0L
        ctxWithRegsInOutput(ctx, Map(
          ErgoBox.R5 -> LongConstant(0L),
          ErgoBox.R4 -> ShortConstant(10))) -> Expected(Success(80956L), 1793, tagRegisterCostDetails2, 1793, Seq.fill(V7CostVectorSize)(2167)),
        ...
        ctxWithRegsInOutput(ctx, Map(
          ...
          ErgoBox.R4 -> ShortConstant(10))) -> Expected(Success(0L), 1784, tagRegisterCostDetails3, 1784, Seq.fill(V7CostVectorSize)(2158)),

        // case returning -1L
        ctxWithRegsInOutput(ctx, Map(
          ErgoBox.R4 -> ShortConstant(10))) -> Expected(Success(-1L), 1777, tagRegisterCostDetails4, 1777, Seq.fill(V7CostVectorSize)(2151))
      ),
      existingFeature(
      { (x: Context) =>
        val tagOpt = x.OUTPUTS(0).R5[Long]
    ...
    verifyCases(
      Seq(
        ctxWithRegsInDataInput(ctx, Map(
          ...
          ErgoBox.R4 -> LongConstant(10))) -> Expected(Success(10L), 1792, tagRegisterCostDetails1, 1792, Seq.fill(V7CostVectorSize)(2162)),
        ctxWithRegsInDataInput(ctx, Map(
          ErgoBox.R5 -> LongConstant(0L),
          ErgoBox.R4 -> ShortConstant(10))) -> Expected(Success(10L), 1791, tagRegisterCostDetails2, 1791, Seq.fill(V7CostVectorSize)(2161)),
        ctxWithRegsInDataInput(ctx, Map(
          ErgoBox.R5 -> LongConstant(2L),
          ErgoBox.R4 -> ShortConstant(10))) -> Expected(Success(0L), 1786, tagRegisterCostDetails3, 1786, Seq.fill(V7CostVectorSize)(2156)),
        ctxWithRegsInDataInput(ctx, Map(
          ErgoBox.R4 -> ShortConstant(10))) -> Expected(Success(-1L), 1779, tagRegisterCostDetails4, 1779, Seq.fill(V7CostVectorSize)(2149))
      ),
      existingFeature(
      { (x: Context) =>
        val tagOpt = x.dataInputs(0).R5[Long]
  ...
  property("Conditional access dataInputs(0).R4 using tag in R5 (plus action)") {
    ...
    verifyCases(
      Seq(
        ctxWithRegsInDataInput(ctx, Map(
          ErgoBox.R5 -> LongConstant(1L),
          ErgoBox.R4 -> LongConstant(10))) -> Expected(Success(80956L), 1796, costDetails1, 1796, Seq.fill(V7CostVectorSize)(2178)),
        ctxWithRegsInDataInput(ctx, Map(
          ErgoBox.R5 -> LongConstant(0L),
          ErgoBox.R4 -> ShortConstant(10))) -> Expected(Success(80956L), 1794, costDetails2, 1794, Seq.fill(V7CostVectorSize)(2176)),
        ctxWithRegsInDataInput(ctx, Map(
          ErgoBox.R5 -> LongConstant(2L),
          ErgoBox.R4 -> ShortConstant(10))) -> Expected(Success(0L), 1786, costDetails3, 1786, Seq.fill(V7CostVectorSize)(2168)),
        ctxWithRegsInDataInput(ctx, Map(
          ErgoBox.R4 -> ShortConstant(10))) -> Expected(Success(-1L), 1779, costDetails4, 1779, Seq.fill(V7CostVectorSize)(2161))
      ),
      existingFeature(
      { (x: Context) =>
        val tagOpt = x.dataInputs(0).R5[Long]
    ...
    verifyCases(
      {
        def successNew[T](v: T, c: Int, newV: T, cd: CostDetails) = Expected(
          ...
          newVersionedResults = {
            val costs = if (activatedVersionInTests >= V6SoftForkVersion) {
              Seq.fill(V7CostVectorSize)(1998)
            }
            else {
              Seq.fill(V7CostVectorSize)(1766)
            }
            Seq.tabulate(V7CostVectorSize)(i => i -> (ExpectedResult(Success(newV), Some(costs(i))) -> Some(cd)))
          }
        )
        Seq(
  ...
  property("LogicalNot equivalence") {
    ...
    verifyCases(
      Seq(
        (true, Expected(Success(false), 1765, costDetails, 1765, Seq.fill(V7CostVectorSize)(1997))),
        (false, Expected(Success(true), 1765, costDetails, 1765, Seq.fill(V7CostVectorSize)(1997)))),
  ...
  property("groupGenerator equivalence") {
    ...
    verifyCases(
      {
        def success[T](v: T) = Expected(Success(v), 1782, costDetails, 1782, Seq.fill(V7CostVectorSize)(2016))
        Seq(
    ...
    if (lowerMethodCallsInTests) {
      ...
      verifyCases(
        {
          def success[T](v: T) = Expected(Success(v), 1872, expCostDetails, 1872, Seq.fill(V7CostVectorSize)(2112))
  ...
  property("Global.xor equivalence") {
    ...
    verifyCases(
      {
        def success[T](v: T, cd: CostDetails) = Expected(Success(v), 1769, cd, 1769, Seq.fill(V7CostVectorSize)(2021))
        Seq(
          ...
          ((Helpers.decodeBytes("0100"), Helpers.decodeBytes("01")) ->
            Expected(Failure(new ArrayIndexOutOfBoundsException("1")),
              ...
              newVersionedResults = {
                val costs = if (activatedVersionInTests >= V6SoftForkVersion) {
                  Seq.fill(V7CostVectorSize)(2021)
                } else {
                  Seq.fill(V7CostVectorSize)(1769)
                }
                Seq.tabulate(V7CostVectorSize) { version =>
    ...
    verifyCases(
      {
        ...
        Seq(
          (Coll[Box](), success(Coll[Box](), 1767, costDetails, 1767, Seq.fill(V7CostVectorSize)(2031))),
          (Coll[Box](b1), success(Coll[Box](), 1772, costDetails2, 1772, Seq.fill(V7CostVectorSize)(2036))),
          (Coll[Box](b1, b2), success(Coll[Box](b2), 1776, costDetails3, 1776, Seq.fill(V7CostVectorSize)(2040)))
        )
      },
  ...
  property("Coll.flatMap equivalence") {
    ...
    verifyCases(
      {
        Seq(
          (Coll[Box](), Expected(Success(Coll[Byte]()), 1773, costDetails1, 1773, Seq.fill(V7CostVectorSize)(2029))),
          ...
          )), 1791, costDetails2, 1791, Seq.fill(V7CostVectorSize)(2047))),
          ...
          )), 1795, costDetails3, 1795, Seq.fill(V7CostVectorSize)(2051)))
        )
      },
    ...
    verifyCases(
      {
        ...
        Seq(
          (Coll[Box](), success(Coll[(Box, Box)](), 1766, costDetails(0), 1766, Seq.fill(V7CostVectorSize)(2018))),
          (Coll[Box](b1), success(Coll[(Box, Box)]((b1, b1)), 1768, costDetails(1), 1768, Seq.fill(V7CostVectorSize)(2020))),
          (Coll[Box](b1, b2), success(Coll[(Box, Box)]((b1, b1), (b2, b2)), 1770, costDetails(2), 1770, Seq.fill(V7CostVectorSize)(2022)))
        )
      },
  ...
  property("Coll.size equivalence") {
    ...
    verifyCases(
      {
        def success[T](v: T) = Expected(Success(v), 1765, costDetails, 1765, Seq.fill(V7CostVectorSize)(2001))
        Seq(
          (Coll[Box](), success(0)),
  ...
  property("Coll.indices equivalence") {
    ...
    verifyCases(
      {
        def success[T](v: T, i: Int) = Expected(Success(v), 1768, costDetails(i), 1768, Seq.fill(V7CostVectorSize)(2008))
        Seq(
  ...
  property("Coll.forall equivalence") {
    ...
    def cases = {
      Seq(
        (Coll[Box](), Expected(Success(true), 1764, costDetails1, 1764, Seq.fill(V7CostVectorSize)(2026))),
        (Coll[Box](b1), Expected(Success(false), 1769, costDetails2, 1769, Seq.fill(V7CostVectorSize)(2031))),
        (Coll[Box](b1, b2), Expected(Success(false), 1769, costDetails3, 1769, Seq.fill(V7CostVectorSize)(2031)))
      )
    }
    if (lowerMethodCallsInTests) {
      verifyCases(
  ...
  property("Coll.exists equivalence") {
    ...
    if (lowerMethodCallsInTests) {
      verifyCases(
        {
          Seq(
            (Coll[Box](), Expected(Success(false), 1764, costDetails1, 1764, Seq.fill(V7CostVectorSize)(2026))),
            (Coll[Box](b1), Expected(Success(false), 1769, costDetails2, 1769, Seq.fill(V7CostVectorSize)(2031))),
            (Coll[Box](b1, b2), Expected(Success(true), 1773, costDetails3, 1773, Seq.fill(V7CostVectorSize)(2035)))
          )
        },
  ...
  property("Coll exists with nested If") {
    ...
    if (lowerMethodCallsInTests) {
      verifyCases(
        {
          Seq(
            (Coll[BigInt](), Expected(Success(false), 1764, costDetails1, 1764, Seq.fill(V7CostVectorSize)(2048))),
            (Coll[BigInt](BigIntZero), Expected(Success(false), 1769, costDetails2, 1769, Seq.fill(V7CostVectorSize)(2053))),
            (Coll[BigInt](BigIntOne), Expected(Success(true), 1772, costDetails3, 1772, Seq.fill(V7CostVectorSize)(2056))),
            (Coll[BigInt](BigIntZero, BigIntOne), Expected(Success(true), 1777, costDetails4, 1777, Seq.fill(V7CostVectorSize)(2061))),
            (Coll[BigInt](BigIntZero, BigInt10), Expected(Success(false), 1777, costDetails4, 1777, Seq.fill(V7CostVectorSize)(2061)))
          )
        },
        existingFeature(
  ...
  property("Coll forall with nested If") {
    ...
    if (lowerMethodCallsInTests) {
      verifyCases(
        {
          Seq(
            (Coll[BigInt](), Expected(Success(true), 1764, costDetails1, 1764, Seq.fill(V7CostVectorSize)(2048))),
            (Coll[BigInt](BigIntMinusOne), Expected(Success(false), 1769, costDetails2, 1769, Seq.fill(V7CostVectorSize)(2053))),
            (Coll[BigInt](BigIntOne), Expected(Success(true), 1772, costDetails3, 1772, Seq.fill(V7CostVectorSize)(2056))),
            (Coll[BigInt](BigIntZero, BigIntOne), Expected(Success(true), 1779, costDetails4, 1779, Seq.fill(V7CostVectorSize)(2063))),
            (Coll[BigInt](BigIntZero, BigInt11), Expected(Success(false), 1779, costDetails4, 1779, Seq.fill(V7CostVectorSize)(2063)))
          )
        },
        existingFeature(
    ...
    verifyCases(
      {
        ...
        Seq(
          Coll[GroupElement]() -> Expected(Success(Coll[Byte]()), 1773, CostDetails.ZeroCost, 1773,
            newVersionedResults = {
              val costs = if (activatedVersionInTests >= V6SoftForkVersion) {
                Seq.fill(V7CostVectorSize)(2029)
              }
              else {
                Seq.fill(V7CostVectorSize)(1773)
              }
              Seq.tabulate(V7CostVectorSize)(v =>
          ...
          Coll[GroupElement](
            ...
            ), 1834, costDetails2, 1834, Seq.fill(V7CostVectorSize)(2090)),
          Coll[GroupElement](
            Helpers.decodeGroupElement("02d65904820f8330218cf7318b3810d0c9ab9df86f1ee6100882683f23c0aee587"),
            Helpers.decodeGroupElement("0390e9daa9916f30d0bc61a8e381c6005edfb7938aee5bb4fc9e8a759c7748ffaa"),
            ...
            ), 1864, costDetails3, 1864, Seq.fill(V7CostVectorSize)(2120))
        )
      },
      existingFeature(
      ...
      val cases = {
        ...
        Seq(
          Coll[GroupElement](
            ...
            expectedDetails = CostDetails.ZeroCost,
            newCost = 1840,
            newVersionedResults = (0 until V7CostVectorSize).map({ version =>
              val costs = if (activatedVersionInTests >= V6SoftForkVersion) {
                Seq.fill(V7CostVectorSize)(2104)
              }
              else {
                Seq.fill(V7CostVectorSize)(1840)
              }
  ...
  property("Coll patch method equivalence") {
    ...
    verifyCases(
      {
        def success[T](v: T, cd: CostDetails) = Expected(Success(v), 1776, cd, 1776, Seq.fill(V7CostVectorSize)(2072))
        Seq(
  ...
  property("Coll updated method equivalence") {
    ...
    verifyCases(
      // (coll, (index, elem))
      {
        def success[T](v: T, cd: CostDetails) = Expected(Success(v), 1774, cd, 1774, Seq.fill(V7CostVectorSize)(2058))
        Seq(
  ...
  property("Coll updateMany method equivalence") {
    ...
    verifyCases(
      // (coll, (indexes, values))
      {
        def success[T](v: T, i: Int) = Expected(Success(v), 1774, costDetails(i), 1774, Seq.fill(V7CostVectorSize)(2066))
        Seq(
  ...
  property("Coll fold method equivalence") {
    ...
    if (lowerMethodCallsInTests) {
      verifyCases(
        ...
        {
          Seq(
            ((Coll[Byte](), 0), Expected(Success(0), 1767, costDetails1, 1767, Seq.fill(V7CostVectorSize)(2049))),
            ((Coll[Byte](), Int.MaxValue), Expected(Success(Int.MaxValue), 1767, costDetails1, 1767, Seq.fill(V7CostVectorSize)(2049))),
            ((Coll[Byte](1), Int.MaxValue - 1), Expected(Success(Int.MaxValue), 1773, costDetails2, 1773, Seq.fill(V7CostVectorSize)(2055))),
            ((Coll[Byte](1), Int.MaxValue), Expected(new ArithmeticException("integer overflow"))),
            ((Coll[Byte](-1), Int.MinValue + 1), Expected(Success(Int.MinValue), 1773, costDetails2, 1773, Seq.fill(V7CostVectorSize)(2055))),
            ((Coll[Byte](-1), Int.MinValue), Expected(new ArithmeticException("integer overflow"))),
            ((Coll[Byte](1, 2), 0), Expected(Success(3), 1779, costDetails3, 1779, Seq.fill(V7CostVectorSize)(2061))),
            ((Coll[Byte](1, -1), 0), Expected(Success(0), 1779, costDetails3, 1779, Seq.fill(V7CostVectorSize)(2061))),
            ((Coll[Byte](1, -1, 1), 0), Expected(Success(1), 1785, costDetails4, 1785, Seq.fill(V7CostVectorSize)(2067)))
          )
        },
        existingFeature(
  ...
  property("Coll fold with nested If") {
    ...
    if (lowerMethodCallsInTests) {
      verifyCases(
        ...
        {
          Seq(
            ((Coll[Byte](), 0), Expected(Success(0), 1767, costDetails1, 1767, Seq.fill(V7CostVectorSize)(2089))),
            ((Coll[Byte](), Int.MaxValue), Expected(Success(Int.MaxValue), 1767, costDetails1, 1767, Seq.fill(V7CostVectorSize)(2089))),
            ((Coll[Byte](1), Int.MaxValue - 1), Expected(Success(Int.MaxValue), 1779, costDetails2, 1779, Seq.fill(V7CostVectorSize)(2101))),
            ((Coll[Byte](1), Int.MaxValue), Expected(new ArithmeticException("integer overflow"))),
            ((Coll[Byte](-1), Int.MinValue + 1), Expected(Success(Int.MinValue + 1), 1777, costDetails3, 1777, Seq.fill(V7CostVectorSize)(2099))),
            ((Coll[Byte](-1), Int.MinValue), Expected(Success(Int.MinValue), 1777, costDetails3, 1777, Seq.fill(V7CostVectorSize)(2099))),
            ((Coll[Byte](1, 2), 0), Expected(Success(3), 1791, costDetails4, 1791, Seq.fill(V7CostVectorSize)(2113))),
            ((Coll[Byte](1, -1), 0), Expected(Success(1), 1789, costDetails5, 1789, Seq.fill(V7CostVectorSize)(2111))),
            ((Coll[Byte](1, -1, 1), 0), Expected(Success(2), 1801, costDetails6, 1801, Seq.fill(V7CostVectorSize)(2123)))
          )
        },
        existingFeature(
  ...
  property("Coll indexOf method equivalence") {
    ...
    verifyCases(
      ...
      {
        def success0[T](v: T) = Expected(Success(v), 1773, costDetails(0), 1773, Seq.fill(V7CostVectorSize)(2061))

        def success1[T](v: T) = Expected(Success(v), 1773, costDetails(1), 1773, Seq.fill(V7CostVectorSize)(2061))

        def success2[T](v: T) = Expected(Success(v), 1774, costDetails(2), 1774, Seq.fill(V7CostVectorSize)(2062))

        def success3[T](v: T) = Expected(Success(v), 1775, costDetails(3), 1775, Seq.fill(V7CostVectorSize)(2063))

        def success12[T](v: T) = Expected(Success(v), 1782, costDetails(12), 1782, Seq.fill(V7CostVectorSize)(2070))
  ...
  property("Coll apply method equivalence") {
    ...
    verifyCases(
      {
        def success[T](v: T) = Expected(Success(v), 1769, costDetails, 1769, Seq.fill(V7CostVectorSize)(2019))
  ...
  property("Coll getOrElse method equivalence") {
    ...
    verifyCases(
      // (coll, (index, default))
      {
        def success[T](v: T) = Expected(Success(v), 1773, costDetails, 1773, Seq.fill(V7CostVectorSize)(2053))
        Seq(
  ...
  property("Tuple size method equivalence") {
    ...
    verifyCases(
      {
        def success[T](v: T) = Expected(Success(v), 1763, costDetails, 1763, Seq.fill(V7CostVectorSize)(1997))
        Seq(
          ((0, 0), success(2)),
          ((1, 2), success(2))
        )
  ...
  property("Tuple apply method equivalence") {
    ...
    verifyCases(
      Seq(((1, 2), Expected(Success(1), cost = 1764, costDetails, 1764, Seq.fill(V7CostVectorSize)(1998)))),
      ...
      preGeneratedSamples = Some(samples))
    verifyCases(
      Seq(((1, 2), Expected(Success(2), cost = 1764, costDetails, 1764, Seq.fill(V7CostVectorSize)(1998)))),
    ...
    verifyCases(
      {
        ...
        Seq(
          (Coll[Int](), Expected(Success(Coll[Int]()), 1768, costDetails(0), 1768, Seq.fill(V7CostVectorSize)(2022))),
          (Coll[Int](1), Expected(Success(Coll[Int](2)), 1771, costDetails(1), 1771, Seq.fill(V7CostVectorSize)(2025))),
          (Coll[Int](1, 2), Expected(Success(Coll[Int](2, 3)), 1774, costDetails(2), 1774, Seq.fill(V7CostVectorSize)(2028))),
      ...
      verifyCases(
        {
          def success[T](v: T, c: Int) = Expected(Success(v), c)
          Seq(
            (Coll[Int](), Expected(Success(Coll[Int]()), 1768, costDetails1, 1768, Seq.fill(V7CostVectorSize)(2054))),
            (Coll[Int](1), Expected(Success(Coll[Int](2)), 1775, costDetails2, 1775, Seq.fill(V7CostVectorSize)(2061))),
            (Coll[Int](-1), Expected(Success(Coll[Int](1)), 1775, costDetails3, 1775, Seq.fill(V7CostVectorSize)(2061))),
            (Coll[Int](1, -2), Expected(Success(Coll[Int](2, 2)), 1782, costDetails4, 1782, Seq.fill(V7CostVectorSize)(2068))),
            (Coll[Int](1, 2, Int.MaxValue), Expected(new ArithmeticException("integer overflow"))),
    ...
    verifyCases(
      {
        Seq(
          (Coll[Int](), Expected(Success(Coll[Int]()), 1768, costDetails(0), 1768, Seq.fill(V7CostVectorSize)(2022))),
          (Coll[Int](1), Expected(Success(Coll[Int](1)), 1771, costDetails(1), 1771, Seq.fill(V7CostVectorSize)(2025))),
          (Coll[Int](1, 2), Expected(Success(Coll[Int](1, 2)), 1775, costDetails(2), 1775, Seq.fill(V7CostVectorSize)(2029))),
          (Coll[Int](1, 2, -1), Expected(Success(Coll[Int](1, 2)), 1778, costDetails(3), 1778, Seq.fill(V7CostVectorSize)(2032))),
          (Coll[Int](1, -1, 2, -2), Expected(Success(Coll[Int](1, 2)), 1782, costDetails(4), 1782, Seq.fill(V7CostVectorSize)(2036)))
        )
      },
    ...
    verifyCases(
      {
        ...
        Seq(
          (Coll[Int](), Expected(Success(Coll[Int]()), 1768, costDetails(0), 1768, Seq.fill(V7CostVectorSize)(2048))),
          (Coll[Int](1), Expected(Success(Coll[Int](1)), 1775, costDetails(1), 1775, Seq.fill(V7CostVectorSize)(2055))),
          (Coll[Int](10), Expected(Success(Coll[Int]()), 1775, costDetails(1), 1775, Seq.fill(V7CostVectorSize)(2055))),
          (Coll[Int](1, 2), Expected(Success(Coll[Int](1, 2)), 1783, costDetails(2), 1783, Seq.fill(V7CostVectorSize)(2063))),
          (Coll[Int](1, 2, 0), Expected(Success(Coll[Int](1, 2)), 1788, costDetails3, 1788, Seq.fill(V7CostVectorSize)(2068))),
          (Coll[Int](1, -1, 2, -2, 11), Expected(Success(Coll[Int](1, 2)), 1800, costDetails5, 1800, Seq.fill(V7CostVectorSize)(2080)))
        )
      },
      ...
      verifyCases(
        {
          val cost = 1772
          val newCost = 1772
          val v3Costs = Seq.fill(V7CostVectorSize)(2050)
          Seq(
            // (coll, (from, until))
  ...
  property("Coll.append equivalence") {
    ...
    if (lowerMethodCallsInTests) {
      verifyCases(
        {
          def success[T](v: T, size: Int) = Expected(Success(v), 1770, costDetails(size), 1770, Seq.fill(V7CostVectorSize)(2022))
          ...
          Seq(
            ...
            (Coll[Int](arr1: _*), Coll[Int](arr2: _*)) -> Expected(Success(Coll[Int](arr1 ++ arr2: _*)), 1771, costDetails(300), 1771, Seq.fill(V7CostVectorSize)(2023))
          )
        },
        existingFeature(
  ...
  property("Option methods equivalence") {
    ...
    verifyCases(
      Seq(
        ...
        (Some(10L) -> Expected(Success(10L), 1765, costDetails1, 1765, Seq.fill(V7CostVectorSize)(1997)))),
    ...
    verifyCases(
      Seq(
        (None -> Expected(Success(false), 1764, costDetails2, 1764, Seq.fill(V7CostVectorSize)(1996))),
        (Some(10L) -> Expected(Success(true), 1764, costDetails2, 1764, Seq.fill(V7CostVectorSize)(1996)))),
      ...
      verifyCases(
        Seq(
          (None -> Expected(Success(1L), 1766, costDetails3, 1766, Seq.fill(V7CostVectorSize)(2006))),
          (Some(10L) -> Expected(Success(10L), 1766, costDetails3, 1766, Seq.fill(V7CostVectorSize)(2006)))),
    ...
    verifyCases(
      Seq(
        (None -> Expected(Success(None), 1766, costDetails4, 1766, Seq.fill(V7CostVectorSize)(2028))),
        (Some(10L) -> Expected(Success(None), 1768, costDetails5, 1768, Seq.fill(V7CostVectorSize)(2030))),
        (Some(1L) -> Expected(Success(Some(1L)), 1769, costDetails5, 1769, Seq.fill(V7CostVectorSize)(2031)))),
    ...
    verifyCases(
      Seq(
        (None -> Expected(Success(None), 1766, costDetails6, 1766, Seq.fill(V7CostVectorSize)(2028))),
        (Some(10L) -> Expected(Success(Some(11L)), 1770, costDetails7, 1770, Seq.fill(V7CostVectorSize)(2032))),
  ...
  property("Option filter,map with nested If") {
    ...
    verifyCases(
      Seq(
        (None -> Expected(Success(None), 1766, costDetails1, 1766, Seq.fill(V7CostVectorSize)(2052))),
        (Some(0L) -> Expected(Success(None), 1771, costDetails2, 1771, Seq.fill(V7CostVectorSize)(2057))),
        (Some(10L) -> Expected(Success(Some(10L)), 1774, costDetails3, 1774, Seq.fill(V7CostVectorSize)(2060))),
        (Some(11L) -> Expected(Success(None), 1774, costDetails3, 1774, Seq.fill(V7CostVectorSize)(2060)))),
      existingFeature(
    ...
    verifyCases(
      Seq(
        (None -> Expected(Success(None), 1766, costDetails4, 1766, Seq.fill(V7CostVectorSize)(2048))),
        (Some(0L) -> Expected(Success(Some(0L)), 1772, costDetails5, 1772, Seq.fill(V7CostVectorSize)(2054))),
        (Some(10L) -> Expected(Success(Some(10L)), 1772, costDetails5, 1772, Seq.fill(V7CostVectorSize)(2054))),
        (Some(-1L) -> Expected(Success(Some(-2L)), 1774, costDetails6, 1774, Seq.fill(V7CostVectorSize)(2056))),
    ...
    verifyCases(
      Seq(
        (None -> Expected(
          ...
          expectedDetails = CostDetails.ZeroCost,
          newCost = 1766,
          newVersionedResults = Seq.tabulate(V7CostVectorSize)({ v =>
            val costs = if (activatedVersionInTests >= V6SoftForkVersion) {
              Seq.fill(V7CostVectorSize)(2042)
            }
            else {
              Seq.fill(V7CostVectorSize)(1766)
            }
        ...
        (Some(0L) -> Expected(
          ...
          expectedV3Costs = Seq.fill(V7CostVectorSize)(2050))),
        (Some(Long.MaxValue) -> Expected(new ArithmeticException("long overflow")))
      ),
      changedFeature(
        changedInVersion = VersionContext.JitActivationVersion,
    ...
    verifyCases(
      Seq(
        Coll[Byte]() -> Expected(
          ...
          costDetailsBlake(0),
          1768,
          Seq.fill(V7CostVectorSize)(2000)
        ),
        ...
        Colls.replicate(1024, 1.toByte) -> Expected(
          ...
          1773,
          Seq.fill(V7CostVectorSize)(2005)
        )
      ),
      existingFeature((x: Coll[Byte]) => SigmaDsl.blake2b256(x),
        "{ (x: Coll[Byte]) => blake2b256(x) }",
    ...
    verifyCases(
      Seq(
        Coll[Byte]() -> Expected(
          ...
          costDetailsSha(0),
          1774,
          Seq.fill(V7CostVectorSize)(2006)
        ),
        Helpers.decodeBytes("e0ff0105ffffac31010017ff33") -> Expected(
        ...
        Colls.replicate(1024, 1.toByte) -> Expected(
          ...
          costDetailsSha(1024),
          1786,
          Seq.fill(V7CostVectorSize)(2018)
        )
      ),
  ...
  property("sigmaProp equivalence") {
    ...
    val v3Costs = Seq.fill(V7CostVectorSize)(1997)
    verifyCases(
      Seq(
    ...
    verifyCases(
      Seq(
        Coll[SigmaProp](
          ...
          )) -> Expected(Success(CSigmaProp(TrivialProp.TrueProp)), 1770, costDetails(1), 1770, Seq.fill(V7CostVectorSize)(2018)),
        Coll[SigmaProp](
          CSigmaProp(
            ProveDHTuple(
              Helpers.decodeECPoint("028cf1686a3275e54441c68d789151bdec40d34d62188bbadce170d96d4ce399b0"),
        ...
        ), 1873, costDetails(3), 1873, Seq.fill(V7CostVectorSize)(2121)),
        ...
        Seq(
          (CSigmaProp(ProveDlog(Helpers.decodeECPoint("02ea9bf6da7f512386c6ca509d40f8c5e7e0ffb3eea5dc3c398443ea17f4510798"))),
            ...
            success(
              ...
              ), 1802, Seq.fill(V7CostVectorSize)(2048)),
          (CSigmaProp(TrivialProp.TrueProp),
            CSigmaProp(ProveDlog(Helpers.decodeECPoint("03a426a66fc1af2792b35d9583904c3fb877b49ae5cea45b7a2aa105ffa4c68606")))) ->
            success(CSigmaProp(ProveDlog(Helpers.decodeECPoint("03a426a66fc1af2792b35d9583904c3fb877b49ae5cea45b7a2aa105ffa4c68606"))), 1784, Seq.fill(V7CostVectorSize)(2030)),
          (CSigmaProp(TrivialProp.FalseProp),
            CSigmaProp(ProveDlog(Helpers.decodeECPoint("03a426a66fc1af2792b35d9583904c3fb877b49ae5cea45b7a2aa105ffa4c68606")))) ->
            success(CSigmaProp(TrivialProp.FalseProp), 1767, Seq.fill(V7CostVectorSize)(2013)),
          (CSigmaProp(ProveDlog(Helpers.decodeECPoint("03a426a66fc1af2792b35d9583904c3fb877b49ae5cea45b7a2aa105ffa4c68606"))),
            CSigmaProp(TrivialProp.TrueProp)) ->
            success(CSigmaProp(ProveDlog(Helpers.decodeECPoint("03a426a66fc1af2792b35d9583904c3fb877b49ae5cea45b7a2aa105ffa4c68606"))), 1784, Seq.fill(V7CostVectorSize)(2030)),
          (CSigmaProp(ProveDlog(Helpers.decodeECPoint("03a426a66fc1af2792b35d9583904c3fb877b49ae5cea45b7a2aa105ffa4c68606"))),
    ...
    verifyCases(
      {
        Seq(
          (CSigmaProp(ProveDlog(Helpers.decodeECPoint("03a426a66fc1af2792b35d9583904c3fb877b49ae5cea45b7a2aa105ffa4c68606"))), true) ->
            Expected(Success(CSigmaProp(ProveDlog(Helpers.decodeECPoint("03a426a66fc1af2792b35d9583904c3fb877b49ae5cea45b7a2aa105ffa4c68606")))), 1786, costDetails2, 1786, Seq.fill(V7CostVectorSize)(2038)),
          (CSigmaProp(ProveDlog(Helpers.decodeECPoint("03a426a66fc1af2792b35d9583904c3fb877b49ae5cea45b7a2aa105ffa4c68606"))), false) ->
            Expected(Success(CSigmaProp(TrivialProp.FalseProp)), 1769, costDetails2, 1769, Seq.fill(V7CostVectorSize)(2021))
        )
      },
      existingFeature(
    ...
    verifyCases(
      {
        ...
        Seq(
          ...
          (CSigmaProp(TrivialProp.TrueProp),
            CSigmaProp(ProveDlog(Helpers.decodeECPoint("03a426a66fc1af2792b35d9583904c3fb877b49ae5cea45b7a2aa105ffa4c68606")))) ->
            success(CSigmaProp(TrivialProp.TrueProp), 1767, Seq.fill(V7CostVectorSize)(2013)),
          (CSigmaProp(ProveDlog(Helpers.decodeECPoint("03a426a66fc1af2792b35d9583904c3fb877b49ae5cea45b7a2aa105ffa4c68606"))),
            CSigmaProp(TrivialProp.FalseProp)) ->
            success(CSigmaProp(ProveDlog(Helpers.decodeECPoint("03a426a66fc1af2792b35d9583904c3fb877b49ae5cea45b7a2aa105ffa4c68606"))), 1784, Seq.fill(V7CostVectorSize)(2030)),
          (CSigmaProp(ProveDlog(Helpers.decodeECPoint("03a426a66fc1af2792b35d9583904c3fb877b49ae5cea45b7a2aa105ffa4c68606"))),
    ...
    verifyCases(
      {
        ...
        Seq(
          (CSigmaProp(ProveDlog(Helpers.decodeECPoint("03a426a66fc1af2792b35d9583904c3fb877b49ae5cea45b7a2aa105ffa4c68606"))), false) ->
            success(CSigmaProp(ProveDlog(Helpers.decodeECPoint("03a426a66fc1af2792b35d9583904c3fb877b49ae5cea45b7a2aa105ffa4c68606"))), 1786, Seq.fill(V7CostVectorSize)(2038)),
          (CSigmaProp(ProveDlog(Helpers.decodeECPoint("03a426a66fc1af2792b35d9583904c3fb877b49ae5cea45b7a2aa105ffa4c68606"))), true) ->
            success(CSigmaProp(TrivialProp.TrueProp), 1769, Seq.fill(V7CostVectorSize)(2021))
        )
      },
      existingFeature(
        (x: (SigmaProp, Boolean)) => x._1 || sigmaProp(x._2),
    ...
    verifyCases(
      {
        ...
        Seq(
          ...
          ), cost = 1771, newDetails(4), expectedNewCost = 1771, Seq.fill(V7CostVectorSize)(2003)),
          CSigmaProp(pk) -> Expected(Success(
            ...
            cost = 1769, newDetails(1), expectedNewCost = 1769, Seq.fill(V7CostVectorSize)(2001)),
          ...
          ), cost = 1772, newDetails(6), expectedNewCost = 1772, Seq.fill(V7CostVectorSize)(2004)),
          ...
          ), cost = 1780, newDetails(18), expectedNewCost = 1780, Seq.fill(V7CostVectorSize)(2012)),
          ...
          ), cost = 1791, newDetails(36), expectedNewCost = 1791, Seq.fill(V7CostVectorSize)(2023))
        )
      },
  ...
  property("anyOf equivalence") {
    ...
    val v3Costs = Seq.fill(V7CostVectorSize)(1996)
    verifyCases(
      Seq(
    ...
    verifyCases(
      Seq(
        (Helpers.decodeGroupElement("02288f0e55610c3355c89ed6c5de43cf20da145b8c54f03a29f481e540d94e9a69")
          ...
          costDetails,
          1782,
          Seq.fill(V7CostVectorSize)(2014)))
      ),
    ...
    verifyCases(
      Seq(
        (Helpers.decodeGroupElement("039c15221a318d27c186eba84fa8d986c1f63bbd9f8060380c9bfc2ef455d8346a")
          ...
          costDetails,
          1836,
          Seq.fill(V7CostVectorSize)(2080)
        ))
      ),
    ...
    verifyCases(
      {
        ...
        Seq(
          ...
          (Coll(t1.bytes:_*), 0) -> Expected(
            ...
            newVersionedResults = {
              val costs = if (activatedVersionInTests >= V6SoftForkVersion) {
                Seq.fill(V7CostVectorSize)(2055)
              }
              else {
                Seq.fill(V7CostVectorSize)(1783)
              }
              (0 until V7CostVectorSize).map({ version =>
          ...
          (Coll(t2.bytes: _*), 0) -> success(Helpers.decodeBytes("100008d3"), costDetails(0), 1783, Seq.fill(V7CostVectorSize)(2055)),
          (Helpers.decodeBytes("100008d3"), 0) -> success(Helpers.decodeBytes("100008d3"), costDetails(0), 1783, Seq.fill(V7CostVectorSize)(2055)),
          // tree with one segregated constant
          (Coll(t3.bytes: _*), 0) -> success(Helpers.decodeBytes("100108d27300"), costDetails(1), 1793, Seq.fill(V7CostVectorSize)(2065)),
          (Helpers.decodeBytes("100108d37300"), 0) -> success(Helpers.decodeBytes("100108d27300"), costDetails(1), 1793, Seq.fill(V7CostVectorSize)(2065)),
          (Coll(t3.bytes: _*), 1) -> success(Helpers.decodeBytes("100108d37300"), costDetails(1), 1793, Seq.fill(V7CostVectorSize)(2065)),
  ...
  property("Random headers access and comparison (originaly from spam tests)") {
    ...
    if (lowerMethodCallsInTests) {
      ...
      val costs = if (activatedVersionInTests >= V6SoftForkVersion) {
        Seq.fill(V7CostVectorSize)(2144)
      }
      else {
        Seq.fill(V7CostVectorSize)(1776)
      }
      verifyCases(
        Seq(
          ctx -> Expected(
            ...
            expectedDetails = CostDetails.ZeroCost,
            newCost = 1776,
            newVersionedResults = (0 until V7CostVectorSize).map({ i =>
  ...
  property("nested loops: map inside fold") {
    ...
    val cases = Seq(
      (keys, initial) -> Expected(Success(Coll[Byte](1, 2, 3, 4, 5)), cost = 1801, expectedDetails = CostDetails.ZeroCost, 1801, Seq.fill(V7CostVectorSize)(2119))
    )
